...
public abstract class PhysicsEntity {
     ...
     * 
     * @see org.kyykka.logic.shape.HitBox#collidesWith(org.kyykka.logic.shape.HitBox) 
     * 
     ...
     * bounces from the ground if necessary, slides along the ground if
     * necessary, freezes the entity if necessary.
     * Does nothing if the entity is frozen.
     * 
    ...
    /**
     * Applies gravity, e.g. changes z-momentum by -1.
     * If the entity is frozen or "underground", does nothing.
     */
    ...
    /**
     * Calculates the velocity of the entity according to the
     * Pythagoras theorem.
     * 
     ...
     * decreases it a little bit.
     * Does nothing if the entity is above ground.
     */
    public void bounce(){
        if(this.getZ() >= 0){
            return;
    ...
    /**
     * Slows the entity down according to friction if it's sliding
     * (if it's z-position is 0)
     * 
    ...
    /**
     * Performs an elastic collision with another entity; changes the
     * momentums of this entity accordingly.
     * Also checks whether the entity should be frozen
     ...
     * 
     * @see org.kyykka.logic.object.PhysicsEntity#collisionVelocity(double, double, double, double)
     * @see org.kyykka.logic.object.PhysicsEntity#checkFreeze() 
     */
